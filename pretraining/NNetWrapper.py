...
class NNetWrapper():
    def __init__(self):
        self.nnet = NeuralNet(args)
        self.grid_x = 3
        self.grid_y = 3
        self.action_size = (self.grid_x+2) * (self.grid_y+2) + 1
    ...
    def train(self, examples):
        ...
        Input:
            examples: a list of training examples, where each example is of form
                      (current robot, pi, v). pi is the MCTS informed policy vector for
                      the given robot state, and v is its value.
        """
        ...
        for epoch in range(args.epochs):
            ...
            for _ in t:
                ...
                # record loss
                pi_losses.update(l_pi.item(), robots.size(0))
                v_losses.update(l_v.item(), robots.size(0))
